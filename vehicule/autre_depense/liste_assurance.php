...
<div align="center"><font color="#2A1FAA" size="7"><b><span class="style Style2">&nbsp Liste des assurances &nbsp</span></b></font> </div>
<br>
<div align="center">
...
<TABLE border="1" align="center" class="tableau">
	...
	<th width="100" align="center">Vehicule</th>
			<th width="100" align="center">cout d'assurance</th>
...
{
if(date('Y-m-d', strtotime($ligne[4])) <date("Y-m-d", time() + 7 * 24 * 60 * 60 ) && date('Y-m-d', strtotime($ligne[4]))>= date( "Y-m-d", time() ))
{?>

<tr  onmouseover="clearTimeout(visib), clearTimeout(hid)" onmouseout="setTimeout( 'blink_hide()', 500 ), window.setTimeout( 'blink_show()', 500 ); " >
