...
<title>Recherche visite technique</title>
</head>
...
<p align="center" class="style2"><strong>- Recherche d'une visite -</strong></p>

<form method="POST" action="result_rech_visite.php">
			<table align="center">
				<tr>
